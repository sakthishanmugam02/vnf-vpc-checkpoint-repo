...
##############################################################################
# ibmcloud_svc_api_key - Cloud Service apikey hosting the CP-GW 
...
variable "ibmcloud_svc_api_key" {
  default     = ""
  type        = "string"
  description = "The APIKey of the IBM Cloud service account that is hosting the CP-GW qcow2 image file. This should be a the API Key of a Service ID in the account"
}

##############################################################################
# ibmcloud_svc_api_key_test - Cloud Service apikey hosting the CP-GW
...
variable "ibmcloud_svc_api_key_test" {
  default     = ""
  type        = "string"
  description = "The APIKey of the IBM Cloud test service account that is hosting the CP-GW qcow2 image file. This should be a the API Key of a Service ID in the account"
}
